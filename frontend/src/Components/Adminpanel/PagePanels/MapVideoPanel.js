...
const MapVideoPanel = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axiosInstance.put(`/map/${id}`, formData, {
        headers: {
      ...
      setIsLoading(false);
      setErrorMessage('Failed to update map video. Please try again.');
      console.error('Error updating map video:', error);
    }
  };
